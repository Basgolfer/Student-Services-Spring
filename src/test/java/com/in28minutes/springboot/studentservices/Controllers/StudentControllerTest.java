...
import com.in28minutes.springboot.studentservices.Models.Course;
import com.in28minutes.springboot.studentservices.Services.StudentService;
...
public class StudentControllerTest {
    ...
    String exampleCourseJson = "{\"id\":\"Course1\",\"name\":\"Spring\",\"description\":\"10 " +
    ...
    public void registerStudentForCourse() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/students/Student1/courses").accept(MediaType.APPLICATION_JSON).content(exampleCourseJson).contentType(MediaType.APPLICATION_JSON);
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
